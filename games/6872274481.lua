...
run(function()
	...
	local blacklisteduserids = {1502104539, 3826146717, 7996706370, 4531785383, 1049767300, 4926350670, 653085195, 184655415, 2752307430, 5087196317, 5744061325, 1536265275}
	local joined = {}
