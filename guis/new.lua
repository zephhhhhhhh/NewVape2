...
local function addBlur(parent, notif)
	...
	blur.Image = getcustomasset('VapeV5/assets/'..(notif and 'blurnotif' or 'blur')..'.png')
...
local function addCloseButton(parent, offset)
	...
	close.Image = getcustomasset('VapeV5/assets/close.png')
...
do
	local res = isfile('VapeV5/profiles/color.txt') and loadJson('VapeV5/profiles/color.txt')
	if res then
...
components = {
	...
	ColorSlider = function(optionsettings, children, api)
		...
		preview.Image = getcustomasset('VapeV5/assets/colorpreview.png')
		...
		expand.Image = getcustomasset('VapeV5/assets/expandicon.png')
		...
		rainbow1.Image = getcustomasset('VapeV5/assets/rainbow_1.png')
		rainbow1.ImageColor3 = color.Light(uipallet.Main, 0.37)
		rainbow1.Parent = rainbow
		local rainbow2 = rainbow1:Clone()
		rainbow2.Image = getcustomasset('VapeV5/assets/rainbow_2.png')
		rainbow2.Parent = rainbow
		local rainbow3 = rainbow1:Clone()
		rainbow3.Image = getcustomasset('VapeV5/assets/rainbow_3.png')
		rainbow3.Parent = rainbow
		local rainbow4 = rainbow1:Clone()
		rainbow4.Image = getcustomasset('VapeV5/assets/rainbow_4.png')
	...
	Dropdown = function(optionsettings, children, api)
		...
		arrow.Image = getcustomasset('VapeV5/assets/expandright.png')
	...
	Targets = function(optionsettings, children, api)
		...
		icon.Image = getcustomasset('VapeV5/assets/targetstab.png')
		icon.Parent = window
		local title = Instance.new('TextLabel')
		title.Name = 'Title'
		...
		optionapi.Players = components.TargetsButton({
			...
			Icon = getcustomasset('VapeV5/assets/targetplayers1.png'),
			IconSize = UDim2.fromOffset(15, 16),
			IconParent = tool,
			ToolIcon = getcustomasset('VapeV5/assets/targetplayers2.png'),
		...
		optionapi.NPCs = components.TargetsButton({
			...
			Icon = getcustomasset('VapeV5/assets/targetnpc1.png'),
			IconSize = UDim2.fromOffset(12, 16),
			IconParent = tool,
			ToolIcon = getcustomasset('VapeV5/assets/targetnpc2.png'),
	...
	TextList = function(optionsettings, children, api)
		...
		buttonicon.Image = optionsettings.Icon or getcustomasset('VapeV5/assets/allowedicon.png')
		...
		icon.BackgroundTransparency = 1
		icon.Image = optionsettings.Tab or getcustomasset('VapeV5/assets/allowedtab.png')
		icon.Parent = window
		local title = Instance.new('TextLabel')
		title.Name = 'Title'
		title.Size = UDim2.new(1, -36, 0, 20)
		...
		addbutton.Image = getcustomasset('VapeV5/assets/add.png')
		...
		function optionapi:ChangeValue(val)
			...
			for i, v in self.List do
				...
				close.BackgroundTransparency = 1
				close.AutoButtonColor = false
				close.Image = getcustomasset('VapeV5/assets/closemini.png')
				close.ImageColor3 = color.Light(uipallet.Text, 0.2)
				close.ImageTransparency = 0.5
				close.Parent = object
				addCorner(close, UDim.new(1, 0))
	...
	TwoSlider = function(optionsettings, children, api)
		...
		knob.Image = getcustomasset('VapeV5/assets/range.png')
		...
		arrow.BackgroundTransparency = 1
		arrow.Image = getcustomasset('VapeV5/assets/rangearrow.png')
...
function mainapi:CreateGUI()
	...
	logo.Image = getcustomasset('VapeV5/assets/guivape.png')
	...
	logov4.Image = getcustomasset('VapeV5/assets/guiv4.png')
	logov4.Parent = logo
	...
	settingsicon.Image = getcustomasset('VapeV5/assets/guisettings.png')
	...
	back.Image = getcustomasset('VapeV5/assets/back.png')
	...
	function categoryapi:CreateBind()
		...
		icon.BackgroundTransparency = 1
		icon.Image = getcustomasset('VapeV5/assets/bind.png')
		...
		bind.MouseEnter:Connect(function()
			...
			icon.Image = getcustomasset('VapeV5/assets/edit.png')
	...
	function categoryapi:CreateOverlayBar()
		...
		button.AutoButtonColor = false
		button.Image = getcustomasset('VapeV5/assets/overlaysicon.png')
		...
		icon.Position = UDim2.fromOffset(10, 13)
		icon.BackgroundTransparency = 1
		icon.Image = getcustomasset('VapeV5/assets/overlaystab.png')
	...
	function categoryapi:CreateGUISlider(optionsettings)
		...
		expandicon.Image = getcustomasset('VapeV5/assets/expandicon.png')
		...
		knob.BackgroundTransparency = 1
		knob.Image = getcustomasset('VapeV5/assets/guislider.png')
		...
		local normalknob = getcustomasset('VapeV5/assets/guislider.png')
		local rainbowknob = getcustomasset('VapeV5/assets/guisliderrain.png')
		local rainbowthread
...
function mainapi:CreateCategory(categorysettings)
	...
	arrow.BackgroundTransparency = 1
	arrow.Image = getcustomasset('VapeV5/assets/expandup.png')
	arrow.ImageColor3 = Color3.fromRGB(140, 140, 140)
	arrow.Rotation = 180
	...
	function categoryapi:CreateModule(modulesettings)
		...
		bindicon.Image = getcustomasset('VapeV5/assets/bind.png')
		...
		bindcover.Image = getcustomasset('VapeV5/assets/bindbkg.png')
		...
		dots.Image = getcustomasset('VapeV5/assets/dots.png')
		...
		bind.MouseEnter:Connect(function()
			...
			bindicon.Image = getcustomasset('VapeV5/assets/new/edit.png')
...
function mainapi:CreateOverlay(categorysettings)
	...
	pin.Image = getcustomasset('VapeV5/assets/pin.png')
...
function mainapi:CreateCategoryList(categorysettings)
	...
	settings.Image = getcustomasset('VapeV5/assets/customsettings.png')
			...
			if categorysettings.Profiles then
				...
				if ind then
					if val ~= 'default' then
						...
						if isfile('VapeV5/profiles/'..val..mainapi.Place..'.txt') and delfile then
							delfile('VapeV5/profiles/'..val..mainapi.Place..'.txt')
						end
					end
				else
		...
		for i, v in (categorysettings.Profiles and mainapi.Profiles or self.List) do
			if categorysettings.Profiles then
				...
				bind.MouseEnter:Connect(function()
					bindtext.Visible = false
					bindicon.Visible = not bindtext.Visible
					bindicon.Image = getcustomasset('VapeV5/assets/edit.png')
...
function mainapi:CreateSearch()
	...
	searchicon.Image = getcustomasset('VapeV5/assets/search.png')
	...
	legiticon.Image = getcustomasset('VapeV5/assets/legit.png')
...
function mainapi:CreateLegit()
	...
	icon.BackgroundTransparency = 1
	icon.Image = getcustomasset('VapeV5/assets/legittab.png')
	icon.ImageColor3 = uipallet.Text
	icon.Parent = window
	local close = addCloseButton(window)
	local children = Instance.new('ScrollingFrame')
...
function mainapi:CreateNotification(title, text, duration, type)
	...
	task.delay(0, function()
		...
		notification.Image = getcustomasset('VapeV5/assets/notification.png')
		...
		iconshadow.Image = getcustomasset('VapeV5/assets/'..(type or 'info')..'.png')
...
function mainapi:Load(skipgui, profile)
    ...
    if isfile('VapeV5/profiles/'..self.Profile..self.Place..'.txt') then
        local savedata = loadJson('VapeV5/profiles/'..self.Profile..self.Place..'.txt')
    ...
    if inputService.TouchEnabled and #self.Keybind == 1 and self.Keybind[1] == 'RightShift' then
        ...
        image.Image = getcustomasset('VapeV5/assets/vape.png')
        image.Parent = button
...
function mainapi:Save(newprofile)
	...
	writefile('VapeV5/profiles/'..self.Profile..self.Place..'.txt', httpService:JSONEncode(savedata))
end
...
mainapi:CreateCategory({
	Name = 'Combat',
	Icon = getcustomasset('VapeV5/assets/combaticon.png'),
	Size = UDim2.fromOffset(13, 14)
})
mainapi:CreateCategory({
	Name = 'Blatant',
	Icon = getcustomasset('VapeV5/assets/blatanticon.png'),
	Size = UDim2.fromOffset(14, 14)
})
mainapi:CreateCategory({
	Name = 'Render',
	Icon = getcustomasset('VapeV5/assets/rendericon.png'),
	Size = UDim2.fromOffset(15, 14)
})
mainapi:CreateCategory({
	Name = 'Utility',
	Icon = getcustomasset('VapeV5/assets/utilityicon.png'),
	Size = UDim2.fromOffset(15, 14)
})
mainapi:CreateCategory({
	Name = 'World',
	Icon = getcustomasset('VapeV5/assets/worldicon.png'),
	Size = UDim2.fromOffset(14, 14)
})
mainapi:CreateCategory({
	Name = 'Inventory',
	Icon = getcustomasset('VapeV5/assets/inventoryicon.png'),
	Size = UDim2.fromOffset(15, 14)
})
mainapi:CreateCategory({
	Name = 'Minigames',
	Icon = getcustomasset('VapeV5/assets/miniicon.png'),
...
local friendssettings = {
	Name = 'Friends',
	Icon = getcustomasset('VapeV5/assets/friendstab.png'),
...
mainapi:CreateCategoryList({
	Name = 'Profiles',
	Icon = getcustomasset('VapeV5/assets/profilesicon.png'),
...
general:CreateButton({
	...
	mainapi.Save = function() end
		if isfile('VapeV5/profiles/'..mainapi.Profile..mainapi.Place..'.txt') and delfile then
			delfile('VapeV5/profiles/'..mainapi.Profile..mainapi.Place..'.txt')
		end
		shared.vapereload = true
		loadstring(game:HttpGet('https://raw.githubusercontent.com/onlyabletolove/VapeV5/refs/heads/main/loader.lua', true))()
	end,
...
local textgui = mainapi:CreateOverlay({
	Name = 'Text GUI',
	Icon = getcustomasset('VapeV5/assets/textguiicon.png'),
...
textguimoduleslist = textgui:CreateTextList({
	...
	Icon = getcustomasset('VapeV5/assets/blockedicon.png'),
	Tab = getcustomasset('VapeV5/assets/blockedtab.png'),
...
VapeLogo.Image = getcustomasset('VapeV5/assets/textvape.png')
...
VapeLogoV4.Image = getcustomasset('VapeV5/assets/textv4.png')
...
targetinfoobj = mainapi:CreateOverlay({
	Name = 'Target Info',
	Icon = getcustomasset('VapeV5/assets/targetinfoicon.png'),
	Size = UDim2.fromOffset(14, 14),
	Position = UDim2.fromOffset(12, 14),
	CategorySize = 240,
	Function = function(callback)
