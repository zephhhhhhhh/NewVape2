...
run(function()
	...
	local capelist = game:GetService("HttpService"):JSONDecode(game:HttpGet("https://github.com/onlyabletolove/whitelists/raw/refs/heads/main/capesveryverytempono.json"))
